...
public class InterfaceConsola {
    ...
    public InterfaceConsola() {
        miObjetoSieteYMedia.iniciarPartida();
        presentarJuego();
        jugar();
    }
    ...
    void turnoJugador() {
        ...
        while (miObjetoSieteYMedia.comprobarSiPasado() && opc == 'C') {
            ...
            mostrarCartas(miObjetoSieteYMedia.cartasJugador);
            System.out.println("\n\tValor de cartas: " + miObjetoSieteYMedia.valorCartas(miObjetoSieteYMedia.cartasJugador));
            if (miObjetoSieteYMedia.comprobarSiPasado()) {
    ...
    void turnoBanca() {
        // lo primero es consultar el valor que alcanzó el jugador en su turn
        if (miObjetoSieteYMedia.comprobarSiPasado()) {
